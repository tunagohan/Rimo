(function () {
    ...
    Z.zg = function(a, c) {
        ...
        var e = d.Fb;
        if (!e) {
            var f = Z.B + Z.mc, g = Z.Vc(f);
            g && (eval(g + aa + f), d = Z.global.$jscomp, e = d.Fb)
        }
        if (!e)
            var h = " requires transpilation but no transpiler was found.", h = h + ' Please add "//javascript/closure:transpiler" as a data dependency to ensure it is included.', e = d.Fb = function(a, c) {
                Z.$c(c + h);
                return a
            };
        return e(a, c)
...
Z.o.bb = function(a, c) {
    ...
    for (var e = 0; e < Z.o.Za.length; e++)
        d = Z.o.Za[e], Object.prototype.hasOwnProperty.call(c, d) && (a[d] = c[d])
};
Z.qg = Y();
...
google.a.c.Xc = function(a, c) {
    ...
    if (0 === a.length)
        ...
        var nb = function(c) {
            var d = google.a.c.Ec, e = a[c++];
            if (e) {
                var f = e, D = google.a.c.pd[e];
